  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (fileInputRef.current.files[0]) {
        const imageRef = ref(storage, `profilePictures/${fileInputRef.current.files[0].name}`);
      ...
      await addDoc(collection(db, "users"), {
        ...
        hasScar,
        scarLocation,
        profilePicture: uploadedImageUrl || null, // here we store the image URL if available
      });
        ...
        <div className="container">
          ...
          <form onSubmit={handleSubmit}>
            <div className="card mb-4">
              ...
              <div className="card-body">
                <div className="text-center mb-4">
                  ...
                  <p className="text-muted small">Upload a profile picture (Optional)</p>
                </div>
                ...
                <div className="row justify-content-center mb-4">
                  <div className="col-md-6">
                    <div className="btn-group w-100">
                      <button 
                        type="button"
                        className={`btn ${gender === 'male' ? 'active' : ''} btn-outline-custom-primary`}
                      ...
                      <button 
                        type="button"
                        className={`btn ${gender === 'female' ? 'active' : ''} btn-outline-custom-primary`}
                ...
                <div className="row g-3">
                  <div className="col-md-6">
                    ...
                    <div className="btn-group w-100">
                      <button 
                        type="button"
                        className={`btn ${bloodType === 'B+' ? 'active' : ''} btn-outline-custom-primary`}
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="btn-group w-100">
                      <button 
                        type="button"
                        className={`btn ${usesWheelchair ? 'active' : ''} btn-outline-custom-primary`}
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="btn-group w-100">
                      <button 
                        type="button"
                        className={`btn ${isDiabetic ? 'active' : ''} btn-outline-custom-primary`}
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="btn-group w-100">
                      <button 
                        type="button"
                        className={`btn ${hasHeartDisease ? 'active' : ''} btn-outline-custom-primary`}
            ...
            <div className="card mb-4">
              ...
              <div className="card-body">
                <p className="text-muted mb-3">Do you have any signs or tattoos? If so, where are they located?</p>
                ...
                <div className="row g-3">
                  <div className="col-md-6">
                    ...
                    <div className="btn-group w-100 mb-2">
                      <button 
                        type="button"
                        className={`btn ${hasTattoo ? 'active' : ''} btn-outline-custom-primary`}
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="btn-group w-100 mb-2">
                      <button 
                        type="button"
                        className={`btn ${hasScar ? 'active' : ''} btn-outline-custom-primary`}
